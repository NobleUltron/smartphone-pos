                    ...
                    <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800 mb-5">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400">Update naming, provider, and account credentials</p>
                            </div>
                        </div>
                        <button
                            type="button"
                    ...
                    <form onSubmit={handleEditAccount} className="space-y-4">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                required
                            />
                            {editForm.errors.name && <p className="text-xs text-rose-500 font-bold">{editForm.errors.name}</p>}
                        </div>
                ...
                <div className="p-6 bg-white dark:bg-slate-900 rounded-2xl">
                    <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800 mb-5">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                <h3 className="text-base font-bold text-slate-900 dark:text-white">Transfer from {account.name}</h3>
                                <p className="text-xs text-slate-500 dark:text-slate-400">Rebalance float to another shop account</p>
                            </div>
                        </div>
                        <button
                            type="button"
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400">
                                    Auditing <strong className="text-slate-900 dark:text-white">{account.name}</strong>
                                </p>
                            </div>
                        </div>
                        <button
            ...
            <Modal show={showStatementModal} onClose={() => setShowStatementModal(false)} maxWidth="sm">
                <div className="p-6 bg-white dark:bg-slate-900 rounded-2xl">
                    ...
                    <div className="space-y-3">
                        <div className="space-y-1.5">
                            <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Start Date (Optional)</label>
                            <input 
                                type="date"
                                className="w-full px-3.5 py-2.5 text-sm font-semibold rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider">End Date (Optional)</label>
                            <input 
                                type="date"
                                className="w-full px-3.5 py-2.5 text-sm font-semibold rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                                value={statementEnd}
                    ...
                    <div className="mt-6 flex items-center justify-between gap-2 pt-4 border-t border-slate-100 dark:border-slate-800">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="px-3.5 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-bold rounded-xl transition-colors flex items-center gap-1.5"
                            >
                            ...
                            <button
                                ...
                                className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl transition-colors flex items-center gap-1.5 shadow-sm"
                            >
